                                ...
                                <View style={{ }}>
                                    <TouchableOpacity style={styles.modalTouchable}>
                                        <View style={styles.modalButton}>
                                            ...
                                            <Text style={styles.iconText}>Download Certificate</Text>
                                        </View>
                                    </TouchableOpacity>
                                    <TouchableOpacity style={styles.modalTouchable}>
                                        <View style={styles.modalButton} >
                                            <Image source={IMAGE.file_download} style={styles.modalImage}/>
                                            <Text style={styles.iconText}>Download our terms of condition</Text>
                                        </View>
                                    </TouchableOpacity>
                                    <TouchableOpacity style={styles.modalTouchable}>
                                        <View style={styles.modalButton}>
                                            <Image source={IMAGE.file_download} style={styles.modalImage}/>
                                            <Text style={styles.iconText}>Download your support card</Text>
                                        </View>
                                    </TouchableOpacity>
                                    <TouchableOpacity 
                                    // onPress={()=>{navigation.navigate("ReportDamage")}}
                                    style={[styles.modalTouchable,{backgroundColor:"#F0C551"}]}>
                                        <View style={[styles.modalButton,{alignSelf:"center"}]}>
                                            <Text style={styles.iconText}>Report damage</Text>
                                        </View>
                                    </TouchableOpacity>
                                </View>
                                <TouchableOpacity
...
export default DataItemContract
